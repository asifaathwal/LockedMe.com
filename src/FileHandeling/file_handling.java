...
File directory = new File("E://simplilearn//");
...
System.out.println("*****************************************");
System.out.println("******* ASIFA PERVEEN*********************");
...
try {
File file = new File("E://simplilearn//" + filename + ".txt");
...
File file = new File("E://simplilearn//" + delete_filename);
if (file.delete()) {
